...
const MODELS = {
  '2.1': 'llama-3.1-8b-instant',
  '2.5': 'llama-3.3-70b-versatile',
  '3.5': 'deepseek-r1-distill-llama-70b'
};
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Vision always uses scout model, otherwise use mode model
    let model;
    if (hasImage) {
      model = 'meta-llama/llama-4-scout-17b-16e-instruct';
    } else {
      model = MODELS[mode] || MODELS['2.1'];
    }
    ...
    // Remove <think>...</think> tags from deepseek reasoning model
